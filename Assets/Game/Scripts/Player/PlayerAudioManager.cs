...
public class PlayerAudioManager : MonoBehaviour
{
    ...
    {
        _punchSfx.volume = Random.Range(0.3f, 5f);
        _punchSfx.pitch = Random.Range(1f, 1.6f);
        _punchSfx.Play();
    }

    private void PlayLandingSfx()
    {
        _landingSfx.volume = Random.Range(0.3f, 5f);
        _landingSfx.pitch = Random.Range(0.8f, 4f);
        _landingSfx.Play();
    }
